 ...
 const skills = [
  ...
  const projects = [
    ...
    },
     {
      ...
      type:'web',
      tech: 'tailwind CSS',
      description: 'A visual playground of handcrafted UI designs built with Tailwind CSS — exploring layouts, components, and modern frontend aesthetics.',
      icon: '🎨',
      link:'https://tailwind-projects-jb01.onrender.com',
      github:["https://github.com/sj-10ps/tailwind-projects"]
    },
        {
  ...
  const experience = [

    {
      ...
      certificate:'https://drive.google.com/file/d/1D4XJItZrw1lA9etfE5REuVtJq5mR9xfl/view?usp=drivesdk',
      link:'https://jobseek-frontend-e93g.onrender.com'
    },
      {
        id:'2',
  ...
  const certifications = [
    ...
    { name: 'Meta React Certification', issuer: 'Meta', year: '2025' ,pdf:'https://www.coursera.org/account/accomplishments/certificate/2EWPSG96WEHQ'},
    { name: 'Meta React Native Certification', issuer: 'Meta', year: '2025' ,pdf:'https://www.coursera.org/account/accomplishments/certificate/M2F9THD8Z3IG'},
    { name: 'IBM Node.js and Express.js Certification', issuer: 'IBM', year: '2025' ,pdf:'https://www.coursera.org/account/accomplishments/certificate/NEVPB62DIQ02'},
     { name: '<Packt> Tailwind Certification', issuer: '<Packt>', year: '2026' ,pdf:'https://www.coursera.org/account/accomplishments/certificate/WFPGS1EDLABG'},
    { name: 'IBM Django with SQL Certification', issuer: 'IBM', year: '2025' ,pdf:'https://www.coursera.org/account/accomplishments/certificate/SAMMOGNF3TSK'},
    {name:'Meta JavaScript Certification',issuer:'Meta',year:'2025',pdf:'https://www.coursera.org/account/accomplishments/certificate/LN8APB1OJTC9'},
    {name:'IBM Python Certification',issuer:'IBM',year:'2025',pdf:'https://www.coursera.org/account/accomplishments/certificate/557XK8V43PIU'},
     {name:'Meta Version Control (Github)',issuer:'Meta',year:"2025",pdf:'https://www.coursera.org/account/accomplishments/certificate/DILLZ6PG1X10'},
    {name:'Meta HTML CSS Certification',issuer:'Meta',year:'2025',pdf:'https://www.coursera.org/account/accomplishments/certificate/Z965GU8DQ37H'},
    {name:'Full stack development using Django Certification',issuer:'Fortune Institute of Technology',year:'2024',pdf:'https://drive.google.com/file/d/1Elmsr4Q_1Atu9FTySIPPmDJhouP3i6e-/view?usp=sharing'},
    {name:'NASA Hackathon Participation Certificate',issuer:'NASA',year:'2024',pdf:'https://drive.google.com/file/d/1MrIt2LT1bson1MbOHOeAE0IPwpPlvnSg/view?usp=sharing'},
  ];
